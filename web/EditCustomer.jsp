...
<form id="contact" action="http://localhost:8080/EditCustomer" method="post">
    <h3>MY PROFILE</h3>
    <fieldset>
        <input name="customerid" value="${customer.id}" type="text" tabindex="1" required>
    </fieldset>
    <fieldset>
    ...
    <fieldset>
        <input name="zipcode" value="${person.zipcode}"placeholder="price" type="text" tabindex="7" required>
    </fieldset>
    <fieldset>
        <input name="country" value="${person.country}"placeholder="quantity" type="text" tabindex="8" required>
    </fieldset>
    <fieldset>
        <input name="email" value="${customer.email}"placeholder="quantity" type="text" tabindex="9" required>
    </fieldset>
    <fieldset>
        <input name="username" value="${customer.username}"placeholder="quantity" type="text" tabindex="10" required>
    </fieldset>
    <fieldset>
        <input name="password" value="${customer.password}"placeholder="quantity" type="text" tabindex="11" required>
    </fieldset>
