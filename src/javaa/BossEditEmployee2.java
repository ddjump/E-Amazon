...
public class BossEditEmployee2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DBConnect.bossEditEmployee(username,password, Integer.parseInt(employee_id),Integer.parseInt(salary)
                    , java.sql.Date.valueOf(datejoined),role,suprevisorid,zipcode,lastname,firstname,dob,country,city,address);
