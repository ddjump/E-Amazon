...
public class EditCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean x = DBConnect.editCustomer(firstname,lastname,dob,address,city,zipcode,country,Integer.parseInt(customerid),username,password,email);
            ...
            person.setPerson_id(Integer.parseInt(customerid));
